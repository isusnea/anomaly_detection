...
def main():
    # Load the input file "vectors_aruba.csv"
    df = pd.read_csv("vectors_aruba.csv")
    ...
    # Save the output to "vectors2_aruba.csv"
    df.to_csv("vectors2_aruba.csv", index=False)
    print("Output saved to vectors2_aruba.csv")
